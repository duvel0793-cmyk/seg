...
def build_model(config: dict):
    ...
    pixel_cfg = config.get("pixel_auxiliary", {})
    pixel_building_cfg = pixel_cfg.get("building_head", {})
    pixel_damage_cfg = pixel_cfg.get("damage_head", {})
    pixel_bridge_cfg = pixel_cfg.get("bridge", {})
    ...
    if model_type in {"oracle_mcd", "oracle_mcd_corn"}:
        ...
        return OracleMCDamageClassifier(
            ...
            enable_pixel_auxiliary=bool(pixel_cfg.get("enabled", False)),
            pixel_aux_decoder_channels=int(pixel_cfg.get("decoder_channels", 128)),
            pixel_aux_use_local_branch_only=bool(pixel_cfg.get("use_local_branch_only", True)),
            pixel_aux_building_head_enabled=bool(pixel_building_cfg.get("enabled", True)),
            pixel_aux_damage_head_enabled=bool(pixel_damage_cfg.get("enabled", True)),
            pixel_aux_damage_num_classes=int(pixel_damage_cfg.get("num_classes", 5)),
            pixel_aux_use_bridge=bool(pixel_cfg.get("use_pixel_bridge", True)),
            pixel_bridge_use_boundary_stats=bool(pixel_bridge_cfg.get("use_boundary_stats", True)),
            pixel_bridge_detach=bool(pixel_bridge_cfg.get("detach_pixel_bridge", False)),
        )
