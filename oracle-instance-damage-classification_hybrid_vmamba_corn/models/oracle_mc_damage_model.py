...
class OracleMCDamageClassifier(nn.Module):
    def __init__(
        ...
        self.encoder = HybridConvVMambaEncoder(
            ...
            conv_stage_depths=conv_stage_depths,
            vmamba_stage_depths=vmamba_stage_depths,
            dims=dims,
            deep_scan_backend=deep_scan_backend,
            vss_d_state=vss_d_state,
            vss_d_conv=vss_d_conv,
            vss_expand=vss_expand,
        )
