...
def build_dataloaders(config: Dict[str, Any]) -> tuple[DataLoader, DataLoader]:
    ...
    train_dataset = XBDInstanceDataset(data_cfg=data_cfg, split=data_cfg.get("split_train", "train"))
    val_dataset = XBDInstanceDataset(data_cfg=data_cfg, split=data_cfg.get("split_val", "val"))
