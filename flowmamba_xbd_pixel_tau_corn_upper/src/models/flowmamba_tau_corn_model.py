"""Legacy filename; top-level VMamba xBD pixel-level damage upper-bound model."""
...
from .backbones import VMambaBackboneWrapper
...
class VMambaTauCornUpper(nn.Module):
    """VMamba backbone + localization + pixel CORN + safe tau + polygon instance aux."""
    ...
    def __init__(self, cfg: Dict[str, object]) -> None:
        ...
        self.backbone = VMambaBackboneWrapper(model_cfg)
...
# Backward-compatible alias for older imports and checkpoints.
FlowMambaTauCornUpper = VMambaTauCornUpper
