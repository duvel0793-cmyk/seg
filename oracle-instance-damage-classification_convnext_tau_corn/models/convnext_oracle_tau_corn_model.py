...
class ConvNeXtOracleTauCORNModel(nn.Module):
    ...
    def get_regularization_terms(self) -> Dict[str, torch.Tensor]:
        return self.head.regularization_terms()

    def get_backbone_pretrained_report(self):
        return self.backbone.get_pretrained_report()
    ...
    def forward(
        ...
        head_outputs = self.head(fused_features)
