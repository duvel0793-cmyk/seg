...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--tau_parameterization", type=str, choices=["sigmoid", "residual"], default=None)
...
def ensure_training_defaults(config: dict[str, Any], default_loss_mode: str = "adaptive_ucl_cda_v3") -> dict[str, Any]:
    ...
    train_cfg.setdefault("tau_parameterization", "sigmoid")
    ...
    train_cfg.setdefault("ambiguity_lr_scale", 0.5)
...
def _run_training(
    ...
    print(f"Tau parameterization: {config['training'].get('tau_parameterization', 'sigmoid')}")
    print(f"Ambiguity lr scale: {float(config['training'].get('ambiguity_lr_scale', 0.5)):.4f}")
