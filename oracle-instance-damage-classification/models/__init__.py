...
def build_model(config: dict):
    ...
    if model_type == "post_only":
        if training_cfg["loss_mode"] == "corn":
    ...
    if model_type in {"oracle_mcd", "oracle_mcd_corn"}:
        ...
        use_ambiguity_head = bool(loss_mode in {"adaptive_ucl_cda", "adaptive_ucl_cda_v2", "adaptive_ucl_cda_v3"})
        default_tau_parameterization = "bounded_sigmoid" if loss_mode == "adaptive_ucl_cda_v3" else "sigmoid"
